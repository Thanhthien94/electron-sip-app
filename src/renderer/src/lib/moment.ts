...
const formatTime = (dateTime: Date) => moment(dateTime).tz('Asia/Ho_Chi_Minh').format('YYYY-MM-DD HH:mm:ss');
const formatTimeUTC = (dateTime: Date) => moment(dateTime).tz('Africa/Abidjan').format('YYYY-MM-DD HH:mm:ss');

const pathTime = (dateTime: Date) => moment(dateTime).tz('Asia/Ho_Chi_Minh').format('YYYY-MM-DD_HH:mm:ss');
